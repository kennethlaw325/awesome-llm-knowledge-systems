...
- **July 2 Cloak-and-Detonate (HKUST)** — peer-reviewed proof that static skill scanning has a *structural* ceiling: SkillCloak evades >90% of the time across 8 scanners, and the same team's runtime checker SkillDetonate catches 97% of attacks at a 2% false-positive rate ([Ch05 §5.10](chapters/05-skill-systems.md), [Ch11](chapters/11-timeline.md), glossary)
